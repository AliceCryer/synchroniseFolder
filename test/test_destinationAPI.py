...
def test_create_file_creates_file(test_dest):
    test_dest.create_file("test.txt", "hello")
    assert (Path.joinpath(test_dest.base_dir, "test.txt")).exists()

def test_create_file_creates_nested_dirs(test_dest):
